...
<table class="table">
  ...
  <tr>
    ...
    <td> {{ $item->endereco }} </td>
    <td> {{ $item->salario }} </td>
    <td><a href="{{ url('/empregado/edit/'.$item->id) }}" class="btn btn-info">Edit</a></td>
    <td><a href="{{ url('/empregado/delete/'.$item->id) }}" class="btn btn-danger" onClick="return confirmDialog();" >Delete</a></td>
